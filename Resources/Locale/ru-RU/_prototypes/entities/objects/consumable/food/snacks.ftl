...
ent-FoodSnackMREBrownieOpen = брауни
    ...
    .suffix = ИРП
ent-FoodSnackSwirlLollipop = леденец завиток
    .desc = Закрученный круг чистого концентрированного сахара. Кто теперь самый большой ребенок на площадке?
...
ent-FoodSnackSwirlLollipop = леденец
    .desc = Закрученный круг из чистого концентрированного сахара. Кто теперь самый крутой на площадке?
